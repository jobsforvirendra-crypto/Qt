...
Item {
    ...
    property int speed : controller ? controller.speed : 0
    width: 150
    height: 150
    ...
    property color gaugeColor: {
        ...
        else if (speed >= 50 && speed <80 ) return "#FFC107"
        else return "#F44336"
    }
   // signal fuelLavel
    ...
    Text {
        ...
        text: gaugeId.speed + "Km/hr"
    }
    Component.onCompleted: {
        console.log( "Speed: ",gaugeId.speed)
    }
